...
from src.infrastructure.computer_vision.utils.google_utils import gsutil_getsize
from src.infrastructure.computer_vision.utils.metrics import fitness
from src.infrastructure.computer_vision.utils.torch_utils import init_torch_seeds
...
def non_max_suppression(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
    ...
    max_det = 12000  # maximum number of detections per image
